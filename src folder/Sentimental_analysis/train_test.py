train_path = r"E:\Infosys internship\req_data\amazon_rev\amazon_reviews_train.csv"
test_path  = r"E:\Infosys internship\req_data\amazon_rev\amazon_reviews_test.csv"
